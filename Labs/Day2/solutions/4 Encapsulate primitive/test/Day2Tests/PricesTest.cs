...
namespace Day2Tests
{
    public class PricesTest
    {
        ...
        public async Task GetAsync_price_for_child_nightticket_should_be_free()
        {
            ...
            // Assert
            ((OkObjectResult)price).Value.Should().BeEquivalentTo(new { Cost = 0 });
        }
        ...
        public async Task GetAsync_price_for_senior_nightticket_should_be_8()
        {
            ...
            // Assert
            ((OkObjectResult)price).Value.Should().BeEquivalentTo(new { Cost = 8 });
        }
        ...
        public async Task GetAsync_price_for_senior_dayticket_be_27()
        {
            ...
            // Assert
            ((OkObjectResult)price).Value.Should().BeEquivalentTo(new { Cost = 27 });
        }
        ...
        public async Task GetAsync_price_for_unknown_age_dayticket_should_be_fullprice()
        {
            ...
            // Assert
            ((OkObjectResult)price).Value.Should().BeEquivalentTo(new { Cost = 35 });
        }
